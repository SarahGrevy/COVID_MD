...
SESSION_CONFIGS = [dict(name='Random_Order_1', num_demo_participants=2, app_sequence=['Hermione_Test','Context', 'Demographic','Shared_reality', 'Demographic'], my_key=5, my_key2=0)]
